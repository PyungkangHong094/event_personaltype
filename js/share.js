...
async function startNativeShare() {
  await navigator.share({
    title: 'Finding a hidden professional character inside me.',
    text: 'Everyone has a perfect job! Find a professional character hiding inside me!',
...
async function copyToClipboard() {
  ...
  if (isSupportedClipboardCommand) {
    ...
    alert('COPY THE LINK! SHARE WITH FRIENDS ><')
    return
  }
